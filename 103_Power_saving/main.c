...
void vTask1Handler(void *pvParameters){
	...
	while(1){
		...
		sprintf(user_msg, "State of Led %d\r\n ", state);
		printmsg(user_msg);
...
// Impliment idle hook task after enebling macro in config file
void aApplicationIdleHook(void){
	// put the processor in normal sleeo mode
